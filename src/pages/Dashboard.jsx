...
const Dashboard = () => {
  ...
  if (authLoading || dataLoading) {
    return (
      <div className="min-h-screen bg-brand-darker flex items-center justify-center pt-16">
        <div className="flex flex-col items-center">
          ...
          <p className="text-slate-400 text-xs font-semibold">Verifying session...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-brand-darker min-h-screen pt-24 pb-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      {/* Background Decor */}
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-brand-primary/10 rounded-full filter blur-[150px] pointer-events-none z-0"></div>
